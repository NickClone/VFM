    ...
    public class Banner
    {
        ...
        public Banner(User user) {
            ...
            if (user is Administrator)
            {
                ...
                this.banner = this.banner + "<input id='mhdnAccount' type='hidden' value=" + user.Account + " />";
                this.banner = this.banner + "<input id='mhdnApellido' type='hidden' value=" + user.Apellido + " />";
                this.banner = this.banner + "<div class='row'><div class='container' id='title'><div class='col-md-12 col-md-offset-4'><h1 id ='BanTit'><strong>VFM</strong>Admin</h1></div><div class='col-md-3'><h5 id='adm'> USUARIO: " + user.Account + "   NOMBRE: " + user.Apellido + ", " + user.Nombre + "</h5></div></div></div>";
