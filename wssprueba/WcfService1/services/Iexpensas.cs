...
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the interface name "Iexpensas" in both code and config file together.
    [ServiceContract]
    public interface Iexpensas
    {
        ...
        Stream listarExpensas(User admin);
    }
}
